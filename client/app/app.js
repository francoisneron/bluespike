...
angular.module('dareApp', [
  ...
  'facebook'
    ...
    $translateProvider.translations('en', {
      'DARE_SITE_TITLE': 'Mojo dare event',
      'BRAND_NAME' : 'Mojo',
      'VIDEOS' : 'Videos',
      'MY_VIDEOS' : 'My videos',
      'ADD_VIDEO' : 'Add video',
      'DARES' :  'Dares',
      'VALUE_PROPOSITION' : 'Mojo concept',
      'CALL_TO_ACTION' : 'Choose your dare',
      ...
      'ENTER' : 'Enter',
      'LEAVE' : 'Leave',
      'YOU_MUST_BE_18' : 'You must be 18 or older to enter this site.',
      'CREATE' : 'Create',
      'SWITCH_LANGUAGE': 'FR',
      'OTHER_LANG_KEY': 'fr',
    });
    $translateProvider.translations('fr', {
      'DARE_SITE_TITLE': 'Concours Mojo',
      'BRAND_NAME' : 'Mojo',
      'VIDEOS' : 'Les vidéos',
      'MY_VIDEOS' : 'Mes vidéos',
      'ADD_VIDEO' : 'Ajouter un vidéo',
      'DARES' :  'Les défis',
      'VALUE_PROPOSITION' : 'Le concept Mojo',
      ...
      'ENTER' : 'Entrer',
      'LEAVE' : 'Partir',
      'YOU_MUST_BE_18' : 'Vous devez avoir 18 ans ou plus pour entrer sur ce site.',
      'CREATE' : 'Créer',
      'SWITCH_LANGUAGE': 'EN',
      'OTHER_LANG_KEY': 'en',
    });
